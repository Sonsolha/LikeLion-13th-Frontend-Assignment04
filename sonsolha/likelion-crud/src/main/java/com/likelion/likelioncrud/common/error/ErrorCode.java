...
public enum ErrorCode {
    ...
    MOVIE_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 영화가 없습니다. movieId = ", "NOT_FOUND_404"),
    TICKET_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "해당 예매 내역이 없습니다. ticketId = ", "NOT_FOUND_404"),
